      ...
      <ScrollView style={{ width: "100%" }}>
        <View style={styles.Box}>
          ...
          <View style={styles.cardContainer}>
            ...
            >
              <ImageBackground
                source={require("../../assets/images/advice.jpg")}
                resizeMode="cover"
                style={styles.image}
            ...
            <Pressable
              style={styles.card}
              onPress={() => navigation.navigate("GesConseil")}
            >
              <ImageBackground
                source={require("../../assets/images/advi.jpg")}
                resizeMode="cover"
                style={styles.image}
                imageStyle={{ borderRadius: 6 }}
              >
        ...
        <View style={styles.Box}>
          ...
          <View style={styles.cardContainer}>
            <TouchableOpacity
              style={styles.card}
              onPress={() => navigation.navigate("Potager")}
            >
              <ImageBackground
                source={require("../../assets/images/potaa.jpg")}
                resizeMode="cover"
                style={styles.image}
                imageStyle={{ borderRadius: 6 }}
              >
            ...
            <Pressable
              style={styles.card}
              onPress={() => navigation.navigate("GesPotager")}
            >
              <ImageBackground
                source={require("../../assets/images/gest.jpg")}
                resizeMode="cover"
                style={styles.image}
                imageStyle={{ borderRadius: 6 }}
              >
        ...
        <View style={styles.Box}>
          ...
          <View style={styles.cardContainer}>
            ...
            <Pressable
              style={styles.card}
              onPress={() => navigation.navigate("GesOff")}
            >
              <ImageBackground
                source={require("../../assets/images/voir.jpg")}
                resizeMode="cover"
                style={styles.image}
                imageStyle={{ borderRadius: 6 }}
              >
        ...
        <View style={styles.Box}>
          ...
          <View style={styles.cardContainer}>
            ...
            <Pressable
              style={styles.card}
              onPress={() => navigation.navigate("GesList")}
            >
              <ImageBackground
        ...
        <View style={styles.Box}>
          ...
          <View style={styles.cardContainer}>
            ...
            >
              <ImageBackground
                source={require("../../assets/images/usrg.jpg")}
                resizeMode="cover"
                style={styles.image}
                imageStyle={{ borderRadius: 6 }}
              >
