...
import { Text, View, SafeAreaView, ScrollView, TextInput, Pressable, Image, FlatList, VirtualizedList } from 'react-native';
...
const Product = ({product}) =>{
  ...
  return (
    <View style={styles.card3}>
        <Pressable>
            <Image source={require('../assets/tomato.png')} style={{width:150,height:150}} />
        </Pressable>
    ...
    <SafeAreaView  style={styles.container3}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.bloc1}>
          <Text style={{fontSize:24,marginVertical:10}}>Produit populaire</Text>
